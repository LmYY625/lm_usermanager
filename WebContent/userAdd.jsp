...
<body>
<% User myuser1 = (User)request.getSession().getAttribute("user"); %>
	<div class="container">
<!-- container-fluid -->
	...
	<h4>欢迎您，<%=myuser1.getUsername() %>&nbsp;&nbsp;&nbsp;&nbsp;<a href="UserServlet?type=quit">退出添加</a></h4>
	</div>
	...
	<div class="col-sm-10">
	<input type="text" name="username" id="inputUserName" placeholder="姓名" class="form-control"></div></div>
	<div class="form-group">
	<label for="inputUserName" class="col-sm-2 control-label">密码：</label>
	<div class="col-sm-10">
	<input type="text" name="password" id="inputPassword" placeholder="密码" class="form-control"></div></div>
	<div class="form-group">
	<label for="inputGrade" class="col-sm-2 control-label">等级：</label>
	<div class="col-sm-10">
	<input type="text" name="grade" id="inputGrade" placeholder="等级" class="form-control"></div></div>
	<div class="form-group">
	<label for="inputUserName" class="col-sm-2 control-label">邮箱：</label>
	<div class="col-sm-10">
	<input type="text" name="email" id="inputEmail" placeholder="邮箱" class="form-control"></div></div>
	<div class="form-group">
